        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Enrollment form submitted successfully!</h1>
                    <p style="font-size:20px;">"Thank you for submitting your enrollment form! Your application is being reviewed, and we kindly ask you to wait patiently for approval. 
                        The confirmation will be sent to you via Gmail once the process is complete. We appreciate your understanding!"</p>

                        <div style="width: 300px; padding: 2rem;">
                            <a href="{{ route('index') }}" style="width: 100%; text-decoration: none;">
                                <button type="button" style="width: 100%; padding: 1rem; background-color: #F05A7E; 
                                color: white; border: none; border-radius: 0.25rem; margin-left: 145px;">Home Page</button>
                            </a>
                        </div>
                </div>
            </div>
